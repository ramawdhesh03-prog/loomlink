    ...
    <main style={{ padding: '60px 24px', maxWidth: '680px', margin: '0 auto' }}>
      <div style={{
        ...
        <h1 style={{
          ...
          fontSize: '1.8rem', margin: 0, color: '#FAF7F2',
        }}>{t('manufacturer_form.title')}</h1>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gap: '20px' }}>
          ...
          >
            {status === 'loading' ? 'Submitting...' : t('manufacturer_form.submit')}
          </button>
        </div>
      </div>
    </main>
